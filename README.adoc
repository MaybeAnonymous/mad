...
* Read the https://github.com/bakkeby/flexipatch-finalizer[Flexipatch Finalizer] README.
...
* Using https://github.com/bakkeby/flexipatch-finalizer[Flexipatch Finalizer]:

** Read their README so you can understand this. This script alters and removes files!

`cd ~/.config/dwm-full && ./flexi-finalizer.sh -o ~/.config/dwm/ --run`
